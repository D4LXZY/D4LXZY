...
Player.Chatted:connect(function(cht)
	if cht:match("-cmds") then
		game:GetService("StarterGui"):SetCore("SendNotification", {
			Title = "FS Cmds By D4LXZY/Samourai";
...
plr.Chatted:Connect(function(x)
    if x == "-antigrab" and _G.antigrab == false then
wait(.8)
_G.antigrab = true
game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "FS cmds";
    Text = "Anti grab : Activated";
})

game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(unpack(args))
elseif x == "-antigrab" and _G.antigrab == true then
wait(.8)
_G.antigrab = false
game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "FS cmds";
    Text = "Anti grab : Desactivated";
})
